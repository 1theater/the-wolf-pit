...
**ЩЕГОЛ.** *(шёпотом)* Дышит ещё… но не слышит уже.

*Дед подходит, долго смотрит. Кладёт ему ладонь на лоб — будто прощается. Выпрямляется — и теперь в нём нет мягкости.*

**ДЕД.** Ему мы уже не поможем. Теперь — крыса. Пока не найдём — никто не дышит.
